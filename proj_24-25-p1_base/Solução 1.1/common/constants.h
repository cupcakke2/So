...
#define MAX_SUBSCRIBE_MESSAGE_SIZE ((size_t) 42) //tamanho max da mensagem de subscrição
#define MAX_SUBSCRIBE_RESPONSE_SIZE ((size_t) 3) //tamanho max da resposta da mensagem de subscrição (op_code + char result + '\0)
#define MAX_UNSUBSCRIBE_MESSAGE_SIZE ((size_t) 42) //tamanho max da mensagem de subscrição
#define MAX_UNSUBSCRIBE_RESPONSE_SIZE ((size_t) 3) //tamanho max da resposta da mensagem de subscrição (op_code + char result + '\0)
#define MAX_REQUEST_SIZE 42 //tamanho max para qualquer request
#define MAX_KEY_SIZE 41 //tamanho max de um key
#define MAX_VALUE_SIZE 41 //tamanho max de um value
#define MAX_DISCONNECT_MESSAGE_SIZE ((size_t) 2) //tamanho max da messagem de desconexao (op_code) + '\0'
#define MAX_DISCONNECT_RESPONSE_SIZE ((size_t) 3) //tamanho max da messagem de desconexao (op_code + char result + '\0')
